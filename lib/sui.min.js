...
})(window, function(t, e, n, i, o, r, c, s, a, l) {
  return (function(t) {
    var e = {}
    function n(i) {
        ...
        function(t) {
          ...
          function m(t) {
            v.forEach(e => {
              ...
              (t.prototype.$SxNotice = r.default),
              (t.prototype.$SxMessage = c.default),
              (t.prototype.$SxLoading = f.default)
          }
    ...
    function(t, e) {
      ...
      function h() {
        u &&
          a &&
          ((u = !1), a.length ? (l = a.concat(l)) : (d = -1), l.length && p())
      }
      function p() {
        if (!u) {
          var t = s(h)
    ...
    function(t, e, n) {
      ...
      var i = n(4),
        ...
        r = (n(75), n(76)),
        c = n(82)
      ;(r.default.createFromSymbol = function(t) {
        return new o.a((e, n) => {
    ...
    function(t, e, n) {
      ...
      t.exports = function(t, e, n, f, v, m, y) {
        a(n, e, f)
        var b,
          z,
          M,
        ...
        if (
          (k &&
            ...
            M.next &&
            (l(M, w, !0), i || 'function' == typeof M[d] || c(M, d, p)),
          x &&
            L &&
            'values' !== L.name &&
            ((_ = !0),
      ...
      var i = n(14),
        ...
        a = function(t, e, n) {
          var l,
            ...
            b = p ? o : o[e] || (o[e] = {}),
            z = b.prototype,
            M = p ? i : f ? i[e] : (i[e] || {}).prototype
          for (l in (p && (n = e), n))
            ((u = !h && M && void 0 !== M[l]) && s(b, l)) ||
              ((d = u ? M[l] : n[l]),
              (b[l] =
                p && 'function' != typeof M[l]
                  ? n[l]
                  : m && u
                  ? r(d, i)
                  : y && M[l] == d
    ...
    function(t, e, n) {
      ...
      n(18)(c, n(48)('iterator'), function() {
        ...
        (t.exports = function(t, e, n) {
          ;(t.prototype = i(c, { next: o(1, n) })), r(t, e + ' Iterator')
        })
    },
    function(t, e, n) {
      var i = n(20),
    ...
    function(t, e, n) {
      ...
      t.exports = n(23)
        ...
        : function(t, e) {
            o(t)
            for (var n, c = r(e), s = c.length, a = 0; s > a; )
              i.f(t, (n = c[a++]), e[n])
            return t
          }
    },
    ...
    function(t, e, n) {
      ...
      t.exports = function(t, e) {
        ...
        for (; e.length > a; ) i(s, (n = e[a++])) && (~r(l, n) || l.push(n))
        return l
      }
    },
    function(t, e, n) {
    ...
    function(t, e, n) {
      var i = n(43)('wks'),
        ...
        c = 'function' == typeof r
      ;(t.exports = function(t) {
        return i[t] || (i[t] = (c && r[t]) || (c ? r : o)('Symbol.' + t))
      }).store = i
    },
    function(t, e, n) {
      var i = n(28),
    ...
    function(t, e, n) {
      ...
      j ||
        ((S = function(t) {
          f(this, S, 'Promise', '_h'), p(t), i.call(this)
          try {
            t(l($, this, 1), l(V, this, 1))
          } catch (t) {
            V.call(this, t)
          }
        }),
        ...
        (z.f = T = function(t) {
          return t === S || t === c ? new r(t) : o(t)
        })),
        d(d.G + d.W + d.F * !j, { Promise: S }),
        n(47)(S, 'Promise'),
        n(71)('Promise'),
        (c = n(15).Promise),
        d(d.S + d.F * !j, 'Promise', {
    ...
    function(t, e, n) {
      ...
      ;((e = t.exports = function(t, e, n, d, h) {
        ...
        if (r(y)) {
          for (p = s(t.length); p > z; z++)
            if ((m = e ? b(c((f = t[z]))[0], f[1]) : b(t[z])) === l || m === u)
              return m
        } else
          for (v = y.call(t); !(f = v.next()).done; )
            if ((m = o(v, b, f.value, e)) === l || m === u) return m
      }).BREAK = l),
        (e.RETURN = u)
    },
    function(t, e, n) {
    ...
    function(t, e, n) {
      ...
      t.exports = function(t, e) {
        var n,
          c = i(t).constructor
        return void 0 === c || null == (n = i(c)[r]) ? e : o(n)
      }
    },
    function(t, e, n) {
      var i,
    ...
    function(t, e, n) {
      ...
      i(i.P + i.R, 'Promise', {
          ...
          var e = c(this, o.Promise || r.Promise),
            n = 'function' == typeof t
          return this.then(
            n
              ? function(n) {
          ...
          ;(r.innerHTML = a),
            ...
            (t = r.getElementsByTagName('svg')[0]) &&
              ...
              (n = document.body).firstChild
                ? ((i = e), (o = n.firstChild).parentNode.insertBefore(i, o))
                : n.appendChild(e))
        }),
    ...
    function(t, e, n) {
      var i = n(44)('meta'),
        ...
        d = (t.exports = {
          ...
          onFreeze: function(t) {
            return l && d.NEED && a(t) && !r(t, i) && u(t), t
          },
        })
    },
    function(t, e, n) {
    ...
    function(t, e, n) {
      ...
      e.default = {
        ...
        props: {
          ...
          size: {
            default: 'normal',
            validator: t => Object(o.oneOf)(t, ['small', 'normal', 'large']),
          },
          shape: { validator: t => Object(o.oneOf)(t, ['circle']) },
          reverse: { type: Boolean, default: !1 },
          htmlType: {
            default: 'button',
            validator: t => Object(o.oneOf)(t, ['button', 'submit', 'reset']),
          },
    ...
    function(t, e, n) {
      ...
      e.default = {
        ...
        open({
          ...
          icon: c = '',
          onClose: u = () => {},
          transitionName: d = 'notice-move',
          block: h,
        }) {
          this.instance ||
            (this.instance = r.default.newInstance({
              styles: l.styles || a,
    ...
    function(t, e, n) {
      ...
      t.exports =
        ...
        n(24)(function() {
          ...
          ? function(t, e) {
              for (
                var n = s(t), l = arguments.length, u = 1, d = r.f, h = c.f;
                l > u;
                ...
                for (
                  var p,
                    f = a(arguments[u++]),
                    v = d ? o(f).concat(d(f)) : o(f),
                    m = v.length,
                    y = 0;
                  m > y;

                )
                  (p = v[y++]), (i && !h.call(f, p)) || (n[p] = f[p])
              return n
            }
          : l
    },
    ...
    function(t, e, n) {
      ...
      ;(i.default.newInstance = t => {
        const e = t || {},
          n = new r.a({ render: t => t(i.default, { props: e }) }).$mount()
      ...
      e.default = {
        ...
        methods: {
          add(t) {
            ...
            if (t.block && e) return
            this.lastNotice = t
            let n = o()({ title: '', content: '', closable: !1 }, t)
            this.notices.push(n)
          },
          close(t) {
    ...
    function(t, e, n) {
      ...
      e.default = {
        name: 'SxNotice',
        components: { Icon: o.default, RenderCell: r.default },
        props: {
    ...
    function(t, e, n) {
      ...
      n.r(e),
        ...
        n.d(e, 'NON_ABSOLUTE_POSITION', function() {
          return C
        })
      const i = 'sui-',
        o = '#4883FB',
            ...
            e.map(({ label: e, value: c, icon: s, class: a }) =>
              t(
                ...
                [
                  e,
                  !Object(o.isEmpty)(s) &&
                    !Object(o.isEmpty)(s.type) &&
                    ('always' === s.show || ('active' === s.show && n === c)) &&
                    t(i.default, {
                      props: {
                        type: s.type,
                        color: s.color || r.LIGHT_FONT_COLOR,
                        size: s.size || 'normal',
                      },
                      on: {
                        click: t => {
    ...
    function(t, e, n) {
      ...
      const h = {
        button: t => [
          s.default,
          {
            ...Object(u.shallowCopy)(t.data, d.WITHOUT_ATTRS),
            props: { ...t.props },
          },
          t.children,
        ],
    ...
    function(t, e, n) {
      ...
      e.default = {
        ...
        components: { Button: d.default, DatePicker: u.a },
        props: {
          defaultSelect: { type: String, default: 'one' },
          level: {
            validator: t => Object(f.oneOf)(t, ['global', 'fragment']),
            default: 'global',
          },
        ...
        mounted() {
          ...
          t && !Object(f.oneOf)(e, ['date', 'week', 'month']) && (e = 'date')
          let n = v[e],
            i = this.btns[n]
          Object(f.oneOf)(e, ['date', 'week', 'month'])
    ...
    function(t, e, n) {
      ...
      e.default = {
        ...
        props: {
          level: {
            validator: t => Object(r.oneOf)(t, ['global', 'fragment', 'form']),
            default: 'fragment',
          },
        },
        render(t, e) {
    ...
    function(t, e, n) {
      ...
      n.r(e)
      var i = n(82)
      const o = { primary: 2, secondary: 3, small: 4 }
      e.default = {
        name: 'SxHeader',
        functional: !0,
        props: {
    ...
    function(t, e, n) {
      ...
      var i = n(168),
        ...
        c = n(82),
        s = n(141)
      i.default.newInstance = ({ dom: t, ...e }) => {
        const n = e || {},
          o = new r.a({ render: t => t(i.default, { props: n }) }).$mount()
        if (t) {
          const e = window.getComputedStyle(t).getPropertyValue('position')
          s.NON_ABSOLUTE_POSITION.includes(e) ||
            (t.style = 'position: relative;'),
            t.appendChild(o.$el)
        } else document.body.appendChild(o.$el)
        return {
          display(t = !0) {
            o.$el.style = `display: ${t ? 'flex' : 'none'};`
          },
          destroy() {
            t ? t.removeChild(o.$el) : document.body.removeChild(o.$el),
              o.$destroy()
          },
        }
      }
      ...
      e.default = {
        config(t) {
          Object(c.isObject)(t) && (u = t)
        },
        show(t = 'global') {
          let e = {}
          if (
            (Object(c.isObject)(t) &&
              ((e = Object(c.shallowCopy)(t, ['query'])),
              (t = t.query || 'global')),
            a[t])
          )
            a[t].display()
            ...
            let n = null
            if ('global' !== t) {
              if (!(n = document.querySelector(t))) return
              let e = d(n)
              l[e].push(t)
            }
            a[t] = i.default.newInstance({ dom: n, ...u, ...e })
          }
        },
        hide(t = 'global') {
          a[t] && a[t].display(!1)
      ...
      const d = t => {
          let e = t
          for (; e.parentNode; ) {
            if (e.parentNode.__vue__) {
              let t = e.parentNode.__vue__,
                n = h(t._uid)
              return (
                t.$options.beforeDestroy
                  ? t.$options.beforeDestroy.push(n)
                  : (t.$options.beforeDestroy = [n]),
                l[t._uid] || (l[t._uid] = []),
                t._uid
              )
            }
    ...
    function(t, e, n) {
      ...
      e.default = {
        name: 'SxLoading',
        functional: !0,
        props: { icon: { type: Object, default: () => ({}) } },
        render: (t, e) =>
          t('div', { class: 'sui-loading' }, [
            t(i.default, {
              props: {
                type: 'icon-loading-2',
                color: '#6D9CFC',
