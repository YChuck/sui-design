...
/* harmony import */ var _components_modal__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(167);
/* harmony import */ var _components_loading__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(173);
...
function install(_Vue) {
  ...
  _Vue.prototype.$SxModal = _components_modal__WEBPACK_IMPORTED_MODULE_12__["default"];
  _Vue.prototype.$SxLoading = _components_loading__WEBPACK_IMPORTED_MODULE_13__["default"];
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  SxModal: _components_modal__WEBPACK_IMPORTED_MODULE_12__["default"],
  SxLoading: _components_loading__WEBPACK_IMPORTED_MODULE_13__["default"]
});
...
!function (c) {
  ...
  a = function () {
    ...
    o.innerHTML = p, p = null, (c = o.getElementsByTagName('svg')[0]) && (c.setAttribute('aria-hidden', 'true'), c.style.position = 'absolute', c.style.width = 0, c.style.height = 0, c.style.overflow = 'hidden', l = c, (a = document.body).firstChild ? (h = l, (t = a.firstChild).parentNode.insertBefore(h, t)) : a.appendChild(l));
  ...
  }, document.addEventListener('DOMContentLoaded', h, !1)) : document.attachEvent && (t = a, o = c.document, s = !1, (i = function () {
    try {
...
const isFunction = value => /\[object (Function|AsyncFunction)\]/.test(toStr.call(value));
/**
 * 判断数据是否为字符串
 * @param {*} value
 */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NON_ABSOLUTE_POSITION", function() { return NON_ABSOLUTE_POSITION; });
...
/* harmony default export */ __webpack_exports__["default"] = ({
      ...
      btnOpts: [{
        ...
        options: {
          ...
          change: time => {
            ...
            let first = moment__WEBPACK_IMPORTED_MODULE_7___default()(time[0]).startOf('day');
            let last = moment__WEBPACK_IMPORTED_MODULE_7___default()(time[1]).endOf('day');
            this.htmlPrint = `${first.format('YYYY-MM-DD')}~${last.format('YYYY-MM-DD')}`;
            this.$emit('on-change', {
              first,
              last,
  ...
  computed: {
    ...
    btns() {
      ...
      return (showFragment ? btnOpts.slice(0, 3) : btnOpts.slice(0, 6)).concat(showCustom ? btnOpts[6] : []);
    },
    ...
    pickers() {
      ...
      let pickers = this.btns.filter(v => v.options && (v.options.model === 'custom' ? showCustom : true));
  ...
  mounted() {
    ...
    if (Object(_utils__WEBPACK_IMPORTED_MODULE_8__["oneOf"])(defaultSelect, ['date', 'week', 'month'])) {
      ...
      this.modelDate[defaultSelect] = defaultValue ? defaultValue : moment__WEBPACK_IMPORTED_MODULE_7___default()().subtract(defaultSelect === 'date' ? 0 : 1, defaultSelect).format();
...
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(140);
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(vue__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _modal_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(168);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(82);
...
const eventBuilder = function (type, on, keep) {
  return async () => {
    const {
      ...
      content,
      _this
    } = this; // 通过对应的 disabled 变量来进行防抖

    if (modal[`${type}Dis`]) return;
    modal[`${type}Dis`] = true;
    let res;

    if (Object(_utils__WEBPACK_IMPORTED_MODULE_3__["isFunction"])(content[type])) {
      res = await content[type](); // content.ok 返回 false 则明确需要暂停后续操作

      if (type === 'ok' && Object(_utils__WEBPACK_IMPORTED_MODULE_3__["isBoolean"])(res) && !res) {
        modal.okDis = false;
        return;
      } // 根据 弹窗逻辑内部返回 来修改 _this 的对应数据


      if (Object(_utils__WEBPACK_IMPORTED_MODULE_3__["isObject"])(res) && Object(_utils__WEBPACK_IMPORTED_MODULE_3__["isObject"])(_this) && _this._isVue) {
        _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(res).forEach(key => {
          _this[key] = res[key];
        });
      }
    }

    if (Object(_utils__WEBPACK_IMPORTED_MODULE_3__["isFunction"])(on[type])) on[type]();
    modal[`${type}Dis`] = false;
    modal.visible = false; // 根据 keep 属性来确定是否要走销毁逻辑

    !keep && this.remove();
  };
};

_modal_vue__WEBPACK_IMPORTED_MODULE_2__["default"].newInstance = async ({
  ...
  content = Object(_utils__WEBPACK_IMPORTED_MODULE_3__["isFunction"])(content) ? await content() : null;
  ...
  const component = new vue__WEBPACK_IMPORTED_MODULE_1___default.a({
    ...
    mounted() {
      ...
      if (Object(_utils__WEBPACK_IMPORTED_MODULE_3__["isObject"])(_this) && _this._isVue) // 数据关联
        tags.forEach(key => {
          content[key] = _this[key]; // 通过 watch 进行数据更新 (并存储 watch 销毁函数)

          this.unWatchList.push(_this.$watch(key, val => {
            if (val !== content[key]) {
              content[key] = val;
            }
          }));
    ...
    render(h) {
      scopedSlots = Object(_utils__WEBPACK_IMPORTED_MODULE_3__["isFunction"])(scopedSlots) ? scopedSlots(h) : {};
      if (!content) content = scopedSlots.default();else content = h(content);
      return h(_modal_vue__WEBPACK_IMPORTED_MODULE_2__["default"], {
        props,
        on: {
        ...
        scopedSlots: Object(_utils__WEBPACK_IMPORTED_MODULE_3__["shallowCopy"])(scopedSlots, ['default'])
      }, [content]);
    },
...
_modal_vue__WEBPACK_IMPORTED_MODULE_2__["default"].open = ({
  props,
  ...config
}) => {
  return _modal_vue__WEBPACK_IMPORTED_MODULE_2__["default"].newInstance({
    props: { ...props,
      value: true
    },
    ...config
...
/* harmony default export */ __webpack_exports__["default"] = (_modal_vue__WEBPACK_IMPORTED_MODULE_2__["default"]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modal_vue_vue_type_template_id_bfe5252a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(169);
/* harmony import */ var _modal_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(171);
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(81);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_modal_vue_vue_type_template_id_bfe5252a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(170);
    ...
    _c(
      ...
      [
        _c(
          ...
          [
            _vm._t("header", [
              _c("div", { class: _vm.prefixCls + "-header-inner" }, [
                _vm._v(_vm._s(_vm.title))
              ])
            ]),
            _vm._v(" "),
            _vm.hasIcon
              ? _c(
                  "a",
                  { class: _vm.prefixCls + "-close", on: { click: _vm.close } },
                  [
                    _vm._t("close", [
                      _c("Icon", {
                        class: _vm.prefixCls + "-close-icon",
                        attrs: { type: "icon-close", color: "#4A4A4A" }
                      })
                    ])
                  ],
                  2
        ...
        _vm._v(" "),
        _c("div", { class: _vm.prefixCls + "-body" }, [_vm._t("default")], 2),
        _vm._v(" "),
        _vm.hasFooter
          ? _c(
              "div",
              ...
              [
                _vm._t("footer", [
                  _c(
                    "Button",
                    {
                      attrs: { type: "default", disabled: _vm.okDis },
                      on: { click: _vm.ok }
                    },
                  ...
                  _c(
                    "Button",
                    {
                      attrs: { type: "cancel", disabled: _vm.cancelDis },
                      on: { click: _vm.cancel }
                    },
                  ...
                  _vm.hasError
                    ? _c(
                        "Button",
                        {
                          attrs: { type: "error", disabled: _vm.errorDis },
                          on: { click: _vm.error }
                        },
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_modal_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(172);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _loading__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(174);
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(140);
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(vue__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(82);
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(141);
...
_loading__WEBPACK_IMPORTED_MODULE_0__["default"].newInstance = ({
  ...
  if (dom) {
    ...
    if (!_constants__WEBPACK_IMPORTED_MODULE_3__["NON_ABSOLUTE_POSITION"].includes(position)) dom.style = 'position: relative;';
  ...
  return {
    ...
    destroy() {
      if (dom) dom.removeChild(component.$el);else document.body.removeChild(component.$el);
      component.$destroy();
    }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  config(option) {
    if (Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isObject"])(option)) defaultConfig = option;
  },

  show(query = 'global') {
    let option = {}; // 参数处理

    if (Object(_utils__WEBPACK_IMPORTED_MODULE_2__["isObject"])(query)) {
      option = Object(_utils__WEBPACK_IMPORTED_MODULE_2__["shallowCopy"])(query, ['query']);
      query = query.query || 'global';
    }

    if (cache[query]) cache[query].display(); // 存在缓存直接显示
    else {
        let dom = null;
        ...
        cache[query] = _loading__WEBPACK_IMPORTED_MODULE_0__["default"].newInstance({
          dom,
          ...defaultConfig,
          ...option
        });
...
const checkParent = dom => {
  ...
  while (t.parentNode) {
    ...
    if (t.parentNode.__vue__) {
      ...
      if (parentVue.$options.beforeDestroy) parentVue.$options.beforeDestroy.push(fn);else parentVue.$options.beforeDestroy = [fn];
